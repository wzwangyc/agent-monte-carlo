...
This paper demonstrates that agent-based models can be \textbf{rigorous} (with proofs), \textbf{empirically validated} (with 44 years of data), and \textbf{policy-relevant} (with welfare analysis). We invite researchers and practitioners to use our framework for stress testing, policy analysis, and risk management.

The key takeaway is simple: \textbf{markets are complex adaptive systems, not mechanical processes}. Agent Monte Carlo provides a rigorous, empirically validated, and policy-relevant framework for understanding and analyzing these systems.

All code and data are openly available to promote reproducible research. We hope this framework contributes to better understanding of financial markets and better policy design for financial stability.
